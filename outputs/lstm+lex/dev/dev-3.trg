...
A genoux?
À la faiblesse de ce principe, j'ajoutais les observations que nous faisons journellements de la raréfaction et condentation de l'air;
...
Et ce qui est plus remarquable, c'est que la syringue pésée en cet état sans la retirer du vif argent ni la bouger en aucune façon, pèze autant (quoi que l'espace vide en apparence, soit si petit que l'on voudra) que quand, en retirant le piston davantage, on le fait si grand qu'on voudra:
...
Je vous supplie très humblement de croître qu'étant nai de condition libre, je ne sais que c'est de flatter personne, et que je ne m'attache point tant aux choses tiles, que quand vous seriez encore en Auignon, je ne fusse aussi véritablement que je suis à cette heure.
...
Puis que je trouve mon intérêt dans mon devoir, il faut de nécessité que je vous aime si je ne me haï moi-même, et que je sois homme de bien par la propre maxime des méchants.
...
Qu'il croîtrait pour cela? Ciel! que mon cœur patit!
...
ce tuyau a près de 2 aux5 de pouce de Diamètre, si bien que son ouverture est à une ouverture d'un pouce de Diamètre comme 4. et 25. êtant donc environ six fois plus petite, elle se peut fermer avec six fois moins de poids:
...
j'ai craint qu'un autre qui n'y aurait employé le temps, l'argent, ni la peine, me prévenant, donnât au public des choses qu'il n'aurait pas vues, et lesquelles par conséquent, il ne pourrait pas rapporter avec l'exactété et l'ordre nécessaire pour les déduire comme il faut;
...
et qu'elle pèze toujours autant que le corps de la syringue avec le vif argent qu'elle contient de la hauteur de deux pieds trois poulces, sans qu'il y ait encore aucun espace videde en apparence:
...
si on des bouche l'ouverture demeurant toujours enfoncée dans le vif-argent du vaisseau, le vif-argent du tuyau descend en partie, laissant au haut du tuyau un espace videde en apparence, le bas du même tuyau demeurant plein du même vif-argent jusqu'à une certaine hauteur.
