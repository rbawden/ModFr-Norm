...
if [ ! -d $maindir/final-mt-models/lstm ]; then
	...
	wget https://zenodo.org/record/6481539/files/lstm.zip?download=1
...
if [ ! -d $maindir/final-mt-models/smt ]; then
	...
	wget https://zenodo.org/record/6482368/files/smt.zip?download=1
...
if [ ! -d $maindir/final-mt-models/transformer ]; then
	...
	wget https://zenodo.org/record/6482342/files/transformer.zip?download=1
